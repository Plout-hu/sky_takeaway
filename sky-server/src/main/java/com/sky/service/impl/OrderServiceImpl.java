...
public class OrderServiceImpl implements OrderService {
    ...
    public OrderPaymentVO payment(OrdersPaymentDTO ordersPaymentDTO) throws Exception {
        ...
        OrderPaymentVO vo = new OrderPaymentVO("1234", "1234", "1234", "1234", "1234");
//        vo.setPackageStr(jsonObject.getString("package"));
    ...
    public PageResult page(Integer page, Integer pageSize, Integer status) {
        ...
        Page<Orders> ordersPage = (Page<Orders>) orderMapper.pageQuery(pageQueryDTO);
...
//        String lng = location.getString("lng");
        //店铺经纬度坐标
        String shopLngLat = location.getString("location");
        log.info(shopLngLat);
...
//        lng = location.getString("lng");
        //用户收货地址经纬度坐标
        String userLngLat = location.getString("location");
        log.info(userLngLat);
